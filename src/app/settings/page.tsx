  ...
  return (
    <div className="space-y-4 max-w-3xl">
      ...
      <Section title="General">
        <SettingRow label="Platform Name" description="Displayed in emails and browser tab">
          <input
            value={platformName}
        ...
        <SettingRow label="Support Email" description="Students can contact via this address">
          <input
            value={supportEmail}
        ...
        <SettingRow label="Max Resumes per User" description="Free tier limit per student account">
        ...
        <SettingRow label="Public Signup" description="Allow new student registrations">
          <Toggle enabled={publicSignup} onToggle={() => setPublicSignup(!publicSignup)} />
        </SettingRow>
      </Section>

      {/* Features */}
      <Section title="Features">
        <SettingRow label="AI Resume Review" description="Enable AI-powered feedback for students">
          <Toggle enabled={aiReview} onToggle={() => setAiReview(!aiReview)} />
        </SettingRow>
        <SettingRow label="PDF Export" description="Allow students to download resumes as PDF">
          <Toggle enabled={pdfExport} onToggle={() => setPdfExport(!pdfExport)} />
        </SettingRow>
        <SettingRow label="Template Marketplace" description="Let students upload and share community templates">
          <Toggle enabled={marketplace} onToggle={() => setMarketplace(!marketplace)} />
        </SettingRow>
        <SettingRow label="Email Notifications" description="Send activity emails to students on key events">
      ...
      <Section title="Security">
        ...
        <SettingRow label="Maintenance Mode" description="Temporarily disable access for all students">
      ...
      <div className="bg-white border border-red-200 rounded-xl overflow-hidden">
        ...
        <div className="flex items-center justify-between py-3 px-4">
          <div>
            <p className="text-sm font-medium text-gray-800">Clear All Resume Data</p>
            <p className="text-xs text-gray-400 mt-0.5">Permanently delete all student resumes. This cannot be undone.</p>
          </div>
