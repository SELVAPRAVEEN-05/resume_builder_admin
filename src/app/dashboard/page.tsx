...
import { ArrowRight, Download, FileText, UserPlus, Users } from "lucide-react";
        ...
        <Card>
          ...
          <div className="space-y-0">
            {recentUsers.map((user, i) => (
              <div
                key={user.id}
                className={`flex items-center gap-2.5 py-2 ${i < recentUsers.length - 1 ? "border-b border-gray-100" : ""}`}
              >
        ...
        <Card>
          ...
          <div className="space-y-0">
            {recentResumes.map((resume, i) => (
              <div
                key={resume.id}
                className={`flex items-center gap-2.5 py-2 ${i < recentResumes.length - 1 ? "border-b border-gray-100" : ""}`}
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-gray-400">
                    {resume.template} · {resume.student}
                  </p>
                </div>
                <span className="text-[10px] text-gray-400 flex-shrink-0">
                  {resume.created.split(",")[0]}
                </span>
              </div>
            ))}
          </div>
